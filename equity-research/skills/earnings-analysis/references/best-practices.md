...
**Beat/Miss Citations:**
- [ ] Beat/miss analysis cites consensus source (AE composite MCP / openbb preferred — use `equity_estimates_consensus`, `earnings_review`, or `equity_estimates_forward_eps`; fall back to SEC EDGAR filings)
...
- [ ] Consensus data sources listed (AE composite MCP / openbb preferred — `equity_estimates_consensus`, `earnings_review`, `equity_estimates_forward_eps/ebitda/sales`; fall back to SEC EDGAR filings)
