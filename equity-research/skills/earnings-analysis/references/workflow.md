...
- **Consensus estimates** - From AE composite MCP (openbb) as primary source; fall back to SEC EDGAR filings or Yahoo Finance for prices and free data; do NOT reach for Bloomberg, FactSet, or Refinitiv — these are unavailable
