...
Figure X - [Descriptive Title]
[Table content]
Source: Company filings, AE composite MCP (openbb), [Firm Name] estimates.
```
...
Source: AE composite MCP (openbb), company filings, [Firm Name] estimates.
```
...
Source: SEC filings (S-4, 8-K, proxy statements), company filings, [Firm Name] estimates.
```
